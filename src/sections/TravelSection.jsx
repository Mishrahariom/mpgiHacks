  ...
  return (
    ...
    <section id="travels">
      <div className='col-12 col-md-12 d-flex flex-column align-items-center jusitfy-content-center' >
        ...
        <h1 >Free Travel Expence</h1>
        <p className='travels-terms'> <code className='text-warning'> Terms & Condition </code> </p>
        <div style={{ "fontSize": "25px" }} >
          <ul className='travels-list'><li>The Travel Expence of the participants whose colleges are <code className='text-warning'> Kanpur </code> reimbur outsideesd at the <code className='text-warning'> End of the Hackathon.</code></li>
