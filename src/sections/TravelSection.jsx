  ...
  return (
    <section id="travel">
      <div className='d-flex flex-column align-items-center justify-content-between'>
        ...
        <div className='mt-5'>
          <p className='travel-terms'> <span className='text-warning'> Terms & Condition </span> </p>
          <div style={{ "fontSize": "25px" }} >
            <ul className='travel-list'><li>The travel expenses of participants whose colleges are <span className='text-warning'> outside Kanpur </span> will be reimbursed at the<span className='text-warning'> End of the Hackathon.</span></li>
