...
const SpeakerSection = () => {
  return (
    <div id="speakers" className='container-fluid vh-100' style={{"paddingTop": "7rem"}}>
        <h1 className='text-center'>Speakers</h1>
        <div className='card text-center bg-white' style={{"width": "18rem", "height": "25rem", "margin": "auto", "borderRadius": "2rem", "border": "1px solid white"}}>
